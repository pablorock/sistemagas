...
public class Pedido extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Eviar Pedido a Despacho");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(jTextField3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 131, Short.MAX_VALUE)))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String nombre_cliente=jTextField4.getText();
        String codigo_producto=jTextField3.getText();
     ...
     if ("".equals(nombre_cliente))
        {
            ...
            JOptionPane.showMessageDialog(null, "Debe Ingresar Nombre del cliente");
            return;
        }
     ...
     if ("".equals(codigo_producto))
        ...
        String sSQL;
        sSQL="INSERT INTO pedido VALUES (?,?,?)";
        ...
        {
            JOptionPane.showMessageDialog(null, "Pedido No Realizado");
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        String iddespacho=jTextField1.getText();
           
        ConexionMySQL mysql= new ConexionMySQL();
        java.sql.Connection cn= mysql.Conectar();
        
        String sSQL;
        sSQL="INSERT INTO despacho VALUES (?)";
        
        try
        {
            PreparedStatement pst = cn.prepareStatement(sSQL);
            pst.setString(1,iddespacho);
               
            int n = pst.executeUpdate();
            JOptionPane.showMessageDialog(null, "Pedido Enviado al Despachador Exitosamente");
            
        } 
        catch (SQLException ex)
        {
            JOptionPane.showMessageDialog(null, "Pedido No Enviado al Depachador");
        }
